...
/**
 * This class will be the parent class which will be extended by all
 * FragmentActivity type of classes in the application. This has been used to
 * monitor the application presence, i.e., to know whether the application is in
