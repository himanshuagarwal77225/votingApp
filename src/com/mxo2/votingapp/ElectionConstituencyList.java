...
public class ElectionConstituencyList extends ParentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt_title.setText(ElectionConstituencyList.this.getResources()
				.getString(
						R.string.select_default,
						ElectionConstituencyList.this.getResources().getString(
		...
		new FetchListTask(ElectionConstituencyList.this).execute(String
				.valueOf(electionId));

		initMenu("Select", ElectionConstituencyList.this.getResources()
	...
	public boolean setElectionConstituencyList(
			...
			ElectionConstituencyList task_activity) {
	...
	private void showNoDataUI(ElectionConstituencyList task_activity) {
	...
	public void initMenu(String title1, String title2) {
		...
		backIconButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent previsousIntent = new Intent(
						ElectionConstituencyList.this, ElectionList.class);
		...
		textitem1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent item1 = new Intent(ElectionConstituencyList.this,
						HomeScreen.class);
		...
		textitem2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent item2 = new Intent(ElectionConstituencyList.this,
						ElectionList.class);
