...
public class ResultfElectionList extends ParentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt_title.setText(ResultfElectionList.this.getResources().getString(
				R.string.forthcoming)
				+ " "
				+ ResultfElectionList.this.getResources().getString(
						R.string.elections));
		new FetchListTask(ResultfElectionList.this).execute();

		initMenu(
				ResultfElectionList.this.getResources().getString(
						R.string.elections), "Result");
	}

	public boolean setElectionList(ArrayList<Election_pojo> election_list,
			ResultfElectionList task_activity) {
			...
			if (election_list == null) {
				...
				if (!name_array.isEmpty()) {
					...
					LazyImageLoadAdapter list_adapter = new LazyImageLoadAdapter(
							...
							R.layout.rowlayout_resultelection);
	...
	private void showNoDataUI(ResultfElectionList task_activity) {
	...
	private OnItemClickListener itemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent _intent = new Intent(ResultfElectionList.this,
					ResultActivity.class);
			_intent.putExtra("electionId", selElection.getId());
			ResultfElectionList.this.startActivity(_intent);
	...
	private class FetchListTask extends AsyncTask<Void, Void, Boolean> {
		...
		private ResultfElectionList task_activity = null;
		private Progress_Dialog m_ProgressDialog = null;
		private ArrayList<Election_pojo> election_list = null;

		public FetchListTask(ResultfElectionList _activity) {
	...
	public void initMenu(String title1, String title2) {
		...
		backIconButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent previsousIntent = new Intent(ResultfElectionList.this,
						HomeScreen.class);
		...
		textitem1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent item1 = new Intent(ResultfElectionList.this,
						HomeScreen.class);
		...
		textitem2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent item2 = new Intent(ResultfElectionList.this,
						ElectionList.class);
				startActivity(item2);
